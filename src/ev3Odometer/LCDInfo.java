...
/**
 * The LCDInfo class provides the ability to print may helpful values to the
 * screen
 */
public class LCDInfo implements TimerListener {
	...
	/**
	 * This method formats a double to string in order to be displace on the Ev3
	 * Screen
	 *
	 * @param x
	 *            The double to be formated
	 * @para places
	 */
