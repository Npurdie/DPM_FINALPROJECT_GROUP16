...
public class RunEv3 {
	...
	public static void main(String[] args) {
		...
		/*
		 * if(pw.getRole()){ Defender defender = new Defender(leftMotor,
		 * rightMotor, TRACK, WHEEL_RADIUS, odo, lightPoller, navigator, usl,
		 * lsl); defender.startDefense(); } else {
		 */
		Attacker attacker = new Attacker(leftMotor, rightMotor, clawMotor, launcherMotor, TRACK, WHEEL_RADIUS, odo,
				lightPoller, navigator, usl, lsl, launcher);
